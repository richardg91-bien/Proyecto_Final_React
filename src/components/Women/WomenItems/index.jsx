...
const WomenItems = () => {
  ...
  if (loading) {
    return <Spinner message="Cargando productos para mujer..." />;
  }
  ...
  return (
    <>
      <Helmet>
        <title>Ropa para Mujer - Indumentaria Agat</title>
        <meta name="description" content="Explora nuestra colección exclusiva de ropa para mujer. Elegancia y estilo en cada prenda." />
        <meta name="keywords" content="ropa mujer, moda femenina, ropa casual mujer, indumentaria mujer" />
      </Helmet>

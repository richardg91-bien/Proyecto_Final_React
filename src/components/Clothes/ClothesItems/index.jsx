...
const ClothesItems = () => {
  const { products, loading, error, refetch } = useProducts({ type: 'category', value: 'clothes' });
  ...
  if (loading) {
    return <Spinner message="Cargando ropa..." />;
  }
  ...
  return (
    <>
      <Helmet>
        <title>Ropa y Vestimenta - Indumentaria Agat</title>
        <meta name="description" content="Descubre nuestra amplia variedad de ropa. Encuentra el estilo perfecto para cada ocasión." />
        <meta name="keywords" content="ropa, vestimenta, moda, indumentaria, estilo" />
      </Helmet>
